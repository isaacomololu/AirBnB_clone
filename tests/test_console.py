...
class TestConsole(unittest.TestCase):
    ...
    def test_update(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(f"update BaseModel {model_id} first_name")
    ...
    def test_basedotshow(self):
        ...
        self.assertEqual(f.getvalue(), '** no instance found **\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(f'BaseModel.show("idfsdfksdf")')
        self.assertEqual(f.getvalue(), '** no instance found **\n')
    ...
    def test_citydotshow(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(f"City.show('helloWorld')")
        self.assertEqual(f.getvalue(), '** no instance found **\n')
    ...
    def test_statedotshow(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(f"State.show('dsklaf')")
        self.assertEqual(f.getvalue(), '** no instance found **\n')
    ...
    def test_placedotshow(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(f"Place.show('jfslkf')")
        self.assertEqual(f.getvalue(), '** no instance found **\n')
    ...
    def test_amenitydotshow(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(f"Amenity.show('idfdfss')")
        self.assertEqual(f.getvalue(), '** no instance found **\n')
    ...
    def test_reviewdotshow(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd(f"Review.show('flsdj')")
        self.assertEqual(f.getvalue(), '** no instance found **\n')
